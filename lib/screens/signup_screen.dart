...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _loadManagers() async {
    try {
      final res = await ApiService.getPublicManagers();
      if (res['success'] == true) {
        if (mounted) setState(() => _managers = res['data']);
      }
    } catch (e) {
      debugPrint('Error loading managers: ');
    }
  }
  ...
  Future<void> _handleSignup() async {
    ...
    try {
      final response = await ApiService.signup(
        ...
        role: _selectedRole,
        password: _passwordController.text,
        managerId: _selectedRole == 'field_executive' ? _selectedManagerId : null,
        profileImage: _profileImage,
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          onChanged: (value) {
                            setState(() {
                              _selectedRole = value!;
                              if (_selectedRole != 'field_executive') {
                      ...
                      // Manager Dropdown for Field Executive
                      if (_selectedRole == 'field_executive')
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 16),
                          decoration: BoxDecoration(
